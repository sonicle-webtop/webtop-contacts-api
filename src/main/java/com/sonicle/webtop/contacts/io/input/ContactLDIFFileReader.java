 ...
 * @author malbinola
 */
public class ContactLDIFFileReader extends AbstractReader implements ContactFileReader {

	public ContactLDIFFileReader() {
		super(null);
	}
	
	public ContactLDIFFileReader(LogHandler logHandler) {
		super(logHandler);
	}
