 ...
 * @author malbinola
 */
public class ContactAttachmentWithInputRef extends ContactAttachmentWithInput {
	private final String attachmentIdToClone;
	
	public ContactAttachmentWithInputRef(final ContactAttachment attachmentToClone) {
