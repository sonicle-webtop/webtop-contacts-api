...
public interface IContactsManager {
	...
	public ContactList<ContactListRecipient> getContactList(final int contactId) throws WTException;
	public ContactList<ContactListRecipient> getContactList(final int contactId, final BitFlag<ContactGetOptions> opts) throws WTException;
